...
class DynamicReductionNetworkTriton_v1(nn.Module):
    '''
    ...
    def __init__(self, input_dim=4, hidden_dim=64, output_dim=1, k=16, aggr='add', norm=None, 
            ...
            graph_features = 2):
        super(DynamicReductionNetworkTriton_v1, self).__init__()
    ...
    def forward(self, x: Tensor, batch: OptTensor, graph_x: Tensor) -> Tensor:
        '''
